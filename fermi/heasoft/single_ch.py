...
ax1.axhline(y = thrty_p, color='r', label='%30 count')
...
ax1.axvline(x = params.index[0], color='g', linestyle='--', label='%30 index')
ax1.legend(loc="upper right")

ax1.set_ylabel('Count rate/sec')
ax1.set_xlabel('Time since the trigger (sec)')


sec5_count = count[(0 < count.index) & (count.index < 6)]
